...
func main() {
	...
	serverhttp := webserver.NewWebServer(configs.WebServerPort)
	webOrderHandler := NewWebOrderHandler(db, eventDispatcher)
	serverhttp.AddHandler(webserver.MethodPost, "/order", webOrderHandler.Create)
	serverhttp.AddHandler(webserver.MethodGet, "/order", webOrderHandler.List)
